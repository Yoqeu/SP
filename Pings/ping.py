...
from Pings.response import *
from Pings.consts import SUCCESS, FAILED
...
if __name__ == '__main__':
    ...
    print("Google server was reached: ", response.is_reached())
    response.print_messages()
    print("\nBsuir server was reached: ", response.is_reached())
    response = p.ping("bsuir.by")
    response.print_messages()
    response = p.ping("adsadsad.net")
    print("\nadsadsad server was reached: ", response.is_reached())
    response.print_messages()
